//
// Simple example to demonstrate how to takeoff and land using MAVSDK.
//
...
std::shared_ptr<System> get_system(Mavsdk& mavsdk)
{
    ...
    // Wait 3 seconds to find an autopilot system
...
int main(int argc, char** argv)
{
    ...
    // Listen to the altitude of the drone at 1 Hz
