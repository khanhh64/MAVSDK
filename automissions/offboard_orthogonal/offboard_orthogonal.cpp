...
bool offb_ctrl_body(mavsdk::Offboard& offboard)
{
    ...
    // Fly right
    std::cout << "Fly right\n";
    Offboard::VelocityBodyYawspeed fly_right{};
    fly_right.right_m_s = 0.5f;
    offboard.set_velocity_body(fly_right);
    sleep_for(seconds(4));

    // Fly backward
    std::cout << "Fly backward\n";
    Offboard::VelocityBodyYawspeed fly_backward{};
    fly_backward.forward_m_s = -0.5f;
    offboard.set_velocity_body(fly_backward);
    sleep_for(seconds(4));

    // Fly left
    std::cout << "Fly left\n";
    Offboard::VelocityBodyYawspeed fly_left{};
    fly_left.right_m_s = -0.5f;
    offboard.set_velocity_body(fly_left);
    sleep_for(seconds(4));

    // ----------------------------------------
    // Fly down
    std::cout << "Fly down\n";
    Offboard::VelocityBodyYawspeed fly_down{};
    fly_down.down_m_s = 0.25f;
    offboard.set_velocity_body(fly_down);
    sleep_for(seconds(2));

    // Rotate clockwise
    std::cout << "Rotate clockwise\n";
    Offboard::VelocityBodyYawspeed rotate_clockwise{};
    rotate_clockwise.yawspeed_deg_s = 30.0f;
    offboard.set_velocity_body(rotate_clockwise);
    sleep_for(seconds(6));

    // Fly up
    std::cout << "Fly up\n";
    Offboard::VelocityBodyYawspeed fly_up{};
    fly_up.down_m_s = -0.25f;
    offboard.set_velocity_body(fly_up);
    sleep_for(seconds(2));

    // Rotate counterclockwise
    std::cout << "Rotate counterclockwise\n";
    Offboard::VelocityBodyYawspeed rotate_counterclockwise{};
    rotate_counterclockwise.yawspeed_deg_s = -30.0f;
    offboard.set_velocity_body(rotate_counterclockwise);
    sleep_for(seconds(6));
